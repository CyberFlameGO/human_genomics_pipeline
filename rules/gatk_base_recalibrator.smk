rule gatk4_BaseRecalibrator:
    ...
    shell:
        "(time gatk BaseRecalibrator -I {input.bams} -R {input.refgenome} --known-sites {input.dbsnp} -O {output} {params.padding} {params.intervals}) 2> times/gatk4_BaseRecalibrator_time.txt"