rule gatk4_ApplyBQSR:
    ...
    shell:
        "( time gatk ApplyBQSR -I {input.bams} -bqsr {input.recal} -R {input.refgenome} -O {output} {params.padding} {params.intervals} 2> gatk4_ApplyBQSR.stderr ) 2> times/gatk4_ApplyBQSR_time.txt"